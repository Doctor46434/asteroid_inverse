...
def picture_sample(images,LOS_dirs,omegas,batch_size,image_hight = 100,image_width = 100, image_num = 30, random_flag = 1):
    # temp_num = random.sample(range(image_num),1)
    temp_num = [random_flag]
    print(temp_num)
...
folder_path = '/DATA/disk1/asteroid/asteroid_inverse/Instant-ngp/new_dataset/real_data/2024on_submean_reverse_100/10du'
...
output_folder = '/DATA/disk1/asteroid/asteroid_inverse/Instant-ngp/new_dataset/real_data/2024on_submean_reverse_100/10du/output_images'

for i in range(image_num):

    omegas_batch_tensor,LOS_dirs_batch_tensor,range_profile_batch_tensor,doppler_profil_num_tensor = picture_sample(images,LOS_dirs,omegas,batch_size = 40,image_num=image_num, random_flag=i)
    ...
    # 保存图片
    # plt.savefig(output_folder + '/image' + str(i) + '.png', bbox_inches='tight', dpi=300)
    # plt.close(fig)
    plt.imsave(output_folder + '/nerf_image' + str(i) + '.png', range_image1, cmap='gray')
    plt.imsave(output_folder + '/groundtruth_image' + str(i) + '.png', range_image2, cmap='gray')
    # # plt.imsave(output_folder +
    # plt.imsave(output_folder + '/groundtruth_image.png', range_image2, cmap='gray')
    # plt.imsave(output_folder + '/nerf_image'+  +'.png' +  range_image1, cmap='gray')
