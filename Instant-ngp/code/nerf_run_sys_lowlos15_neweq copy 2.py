...
def random_sample(images,LOS_dirs,omegas,batch_size,image_hight = 100,image_width = 97,image_num = 37):
...
# 载入数据
folder_path = '/DATA/disk1/3dmodel/3dmodel/XXX/image1'

# 生成保存路径
experiment_name = 'experiment51'
...
# # 指定预训练模型的路径
# pretrained_model_path = '/DATA/disk1/Instant-ngp/model/experiment35/model_state_dict.pth'  # 修改为您的预训练模型路径
