...
# 指定预训练模型的路径
pretrained_model_path = '/DATA/disk1/asteroid/asteroid_inverse/Instant-ngp/model/experiment199/model_state_dict.pth'  # 修改为您的预训练模型路径
