...
# 输入数据路径
data_path = '/DATA/disk1/asteroid/asteroid_inverse/Instant-ngp/new_dataset/sys_data/geo_0.25round/30du_40dB'
# 输出数据路径
full_path = "/DATA/disk1/asteroid/asteroid_inverse/Instant-ngp/new_dataset/result/peroid_mesh/geo_0.25round"
# 生成保存路径
