...
batch = 30
# 雷达视线方向1
RadarLos = torch.tensor([math.cos(30*math.pi/180),math.sin(30*math.pi/180),0], device=device)
# 角度采样
theta = torch.linspace(2*math.pi,2*math.pi/batch+math.pi,batch).to(device)
# 输入数据路径
data_path = '/DATA/disk1/asteroid/asteroid_inverse/Instant-ngp/new_dataset/sys_data/geo_0.5round/30du_40dB'
# 输出数据路径
full_path = "/DATA/disk1/asteroid/asteroid_inverse/Instant-ngp/new_dataset/result/peroid_mesh/geo_0.5round"
# 生成保存路径
