...
# 读取路径
data_path = '/DATA/disk1/asteroid/asteroid_inverse/Instant-ngp/new_dataset/sys_data/geo40du_wrong20du'
# 数据量
batch = 60
# 雷达视线方向角度
...
# 输出路径
output_path = '/DATA/disk1/asteroid/asteroid_inverse/Instant-ngp/new_dataset/result/wrong_angle_point/geo20du_wrong'
