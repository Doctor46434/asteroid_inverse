...
# 载入数据
folder_path = '/DATA/disk1/asteroid/asteroid_inverse/Instant-ngp/new_dataset/sys_data/arr/30du_20dB'

# 生成保存路径
experiment_name = 'experiment172'
...
# 指定预训练模型的路径
pretrained_model_path = '/DATA/disk1/asteroid/asteroid_inverse/Instant-ngp/model/experiment166/model_state_dict.pth'  # 修改为您的预训练模型路径
