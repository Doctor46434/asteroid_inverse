...
# 载入数据
folder_path = '/DATA/disk1/3dmodel/3dmodel/ISAR_NERF/asteroid_image_nerf_new/real_data_reg_2024On_4'
...
for epoch in range(20000):
    ...
    if epoch % 2000 == 0:
        torch.save(model.state_dict(), 'model_state_dict91.pth')
        torch.save(losses, 'loss_list91.pth')
    loss.backward()
    optimizer.step()
